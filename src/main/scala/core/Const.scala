...
object AddrRegion {
  def ITCM_ADDR = BitPat("b10000000_00000000_????????_????????")  // 0x8000_0000 ~ 0x8000_FFFF
  def DTCM_ADDR = BitPat("b10010000_00000000_????????_????????")  // 0x9000_0000 ~ 0x9000_FFFF
//  def ITCM_ADDR = BitPat("b10000000_00000000_0000????_????????")  // 0x8000_0000 ~ 0x8000_0FFF
//  def DTCM_ADDR = BitPat("b10010000_00000000_0000????_????????")  // 0x9000_0000 ~ 0x9000_0FFF
