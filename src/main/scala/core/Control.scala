...
object Control {
  ...
  val map = Array(
    ...
    CSRRW -> List(Y, N, Y, N, N, N, N, N, N, N, N, N, A_XXX,  B_XXX, IMM_X, ALU_XXX   , BR_XXX, N, LD_XXX, N, ST_XXX, Y, CSR.W, N),
    CSRRS -> List(Y, N, Y, N, N, N, N, N, N, N, N, N, A_XXX,  B_XXX, IMM_X, ALU_XXX   , BR_XXX, N, LD_XXX, N, ST_XXX, Y, CSR.S, N),
    CSRRC -> List(Y, N, Y, N, N, N, N, N, N, N, N, N, A_XXX,  B_XXX, IMM_X, ALU_XXX   , BR_XXX, N, LD_XXX, N, ST_XXX, Y, CSR.C, N),
    CSRRWI-> List(N, N, Y, N, N, N, N, N, N, N, N, N, A_XXX,  B_XXX, IMM_X, ALU_XXX   , BR_XXX, N, LD_XXX, N, ST_XXX, Y, CSR.W, N),
    CSRRSI-> List(N, N, Y, N, N, N, N, N, N, N, N, N, A_XXX,  B_XXX, IMM_X, ALU_XXX   , BR_XXX, N, LD_XXX, N, ST_XXX, Y, CSR.S, N),
    CSRRCI-> List(N, N, Y, N, N, N, N, N, N, N, N, N, A_XXX,  B_XXX, IMM_X, ALU_XXX   , BR_XXX, N, LD_XXX, N, ST_XXX, Y, CSR.C, N),
